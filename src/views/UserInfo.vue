            ...
            <v-layout align-center>
              ...
              <v-flex offset-xs1>
                <v-layout align-end>
                  ...
                  <v-flex shrink>
                    <v-chip id="group" outline disabled color="black" small>{{ $store.state.userInfo.group.text }}</v-chip>
                  </v-flex>
                </v-layout>
                <v-layout align-center>
                  <v-flex shrink>
                    <span id="level" class="font-weight-bold">Lv.{{ $store.state.userInfo.level }}</span>
                  </v-flex>
                  <v-flex xs6 offset-xs1>
                    <v-progress-linear id="exp" height="16" color="progress" background-color="secondary" v-model="$store.state.userInfo.exp.percent"></v-progress-linear>
                  </v-flex>
                </v-layout>
              </v-flex><!--昵称&用户组&等级-->
            </v-layout>
      ...
      <div id="list">
        <v-list>
          ...
          <v-list-tile :to="{name: 'exp-detail', query: {redirect: $route.fullPath}}">
            <v-list-tile-action> <v-icon class="time--text">trending_up</v-icon> </v-list-tile-action>
            <v-list-tile-title>
              <v-layout justify-space-between>
                <span>积分等级</span>
                <v-icon>keyboard_arrow_right</v-icon>
          ...
          <v-list-tile>
            <v-list-tile-action> <v-icon class="time--text">attach_money</v-icon> </v-list-tile-action>
            <v-list-tile-title>
              <v-layout justify-space-between>
                <span>某币充值</span>
                <v-icon>keyboard_arrow_right</v-icon>
