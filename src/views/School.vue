                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    <div class="grey--text text--darken-2">
                                                        <span v-for="(tag, index) in value.tags" :key="index">{{ index===0 ? '' : '/' }}{{ tag }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </v-card-title>
                ...
                recommends: [
                    {
                        ...
                        tags:['Fps','技巧'],
                        id: '1',
                        img: 'https://i0.hdslb.com/bfs/face/e10b0be7f2343ec3289cacb09a68bb66c3d9d23c.jpg@100w_100h.webp'
                    }, {
                        title: '如何在反恐战争中拯救人质',
                        tags:['Fps','彩虹六号'],
                        id: '1',
