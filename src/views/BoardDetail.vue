...
<!--height: 100%;border-radius: 50%">-->
        ...
        <v-container grid-list-md text-xs-center
            ...
            <v-layout row style="height: 100%;align-items: center;">
                ...
                <v-flex xs10 style="background-color: orange;height: 100%;line-height: 48px">
                    <h2 style="color: white">联系企业</h2>
                </v-flex>
            </v-layout>
        </v-container>
    </div>
        ...
        name: "board-detail", data() {
            return {
                ...
                data: {
                    ...
                    article_description: 'APM250+，韩总及以上水平，没有智力视力不好及爱好女装可优先考虑',
                    collect: 0,
                    read: 0,
                    rate: 0,
                    free: 1,
